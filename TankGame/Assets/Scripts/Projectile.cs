...
public class Projectile : MonoBehaviour {
    ...
    void Update()
    {
        ...
        Vector2 vel = new Vector2(xVelo, yVelo);
        ...
        bulletInstance.GetComponent<Rigidbody2D>().isKinematic = false;
        bulletInstance.GetComponent<Rigidbody2D>().AddForce(vel, ForceMode2D.Impulse);
    }
}
